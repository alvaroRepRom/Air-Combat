...
BUILD       :=  build
LIBBUTANO   :=  ../butano-master/butano
PYTHON      :=  python
SOURCES     :=  src ../butano-master/common/src
INCLUDES    :=  include ../butano-master/common/include
DATA        :=
GRAPHICS    :=  graphics ../butano-master/common/graphics
AUDIO       :=  audio ../butano-master/common/audio
ROMTITLE    :=  AIR COMBAT
ROMCODE     :=  SBTP
USERFLAGS   :=  
USERLIBDIRS :=  
